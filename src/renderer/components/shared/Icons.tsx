...
function icon(d: string | string[], fill?: boolean) {
  return function Icon({ size = defaults.size, className }: IconProps) {
...
export const FolderOpenIcon = icon(['M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z'])
export const SaveIcon = icon(['M19 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11l5 5v11a2 2 0 0 1-2 2z', 'M17 21v-8H7v8', 'M7 3v5h8'])
...
export const FilePlusIcon = icon(['M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z', 'M14 2v6h6', 'M12 18v-6', 'M9 15h6'])
export const FileBlankIcon = icon(['M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z', 'M14 2v6h6'])
...
export const UndoIcon = icon(['M3 7v6h6', 'M21 17a9 9 0 0 0-9-9 9 9 0 0 0-6.69 3L3 13'])
...
// Annotation tools
export const HighlightIcon = icon(['M12 20h9', 'M16.5 3.5a2.12 2.12 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z'])
export const TypeIcon = icon(['M4 7V4h16v3', 'M9 20h6', 'M12 4v16'])
export const PenIcon = icon(['M12 19l7-7 3 3-7 7-3-3z', 'M18 13l-1.5-7.5L2 2l3.5 14.5L13 18l5-5z', 'M2 2l7.586 7.586', 'M11 11a2 2 0 1 1 2 2'])
...
export const PaletteIcon = icon(['M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c.9 0 1.7-.8 1.7-1.7 0-.4-.2-.8-.4-1.1-.3-.3-.4-.7-.4-1.1 0-.9.8-1.7 1.7-1.7H16c3.3 0 6-2.7 6-6 0-5.5-4.5-9.6-10-9.6z'])
...
// Rotate
export const RotateCCWIcon = icon(['M1 4v6h6', 'M3.51 15a9 9 0 1 0 2.13-9.36L1 10'])
export const RotateCWIcon = icon(['M23 4v6h-6', 'M20.49 15a9 9 0 1 1-2.12-9.36L23 10'])
...
// Misc
export const EditIcon = icon(['M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7', 'M18.5 2.5a2.12 2.12 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z'])
export const LayersIcon = icon(['M12 2L2 7l10 5 10-5-10-5z', 'M2 17l10 5 10-5', 'M2 12l10 5 10-5'])
export const ScissorsIcon = icon(['M6 9a3 3 0 1 0 0-6 3 3 0 0 0 0 6z', 'M6 21a3 3 0 1 0 0-6 3 3 0 0 0 0 6z', 'M20 4L8.12 15.88', 'M14.47 14.48L20 20', 'M8.12 8.12L12 12'])
export const CheckIcon = icon('M20 6L9 17l-5-5')

// View layout icons
export function FitWidthIcon({ size = 24, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export function ViewOptionsIcon({ size = 24, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
